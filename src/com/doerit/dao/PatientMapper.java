...
public interface PatientMapper {
    ...
    /*to get patient name*/
    @Select("SELECT FIRST_NAME,SURNAME" + 
    		"FROM tbl_patient" + 
    		"INNER JOIN tbl_patient_diagnostic_complaint ON tbl_patient.ID = tbl_patient_diagnostic_complaint.PATIENT_ID;")
    @ResultMap("BaseResultMap")
    Patient viewNameByPrimaryKey(@Param("id")String id);
