	...
	<hr>
				<div class="row">
	            	<div class="col-md-4 col-sm-6 col-xs-12" style="padding: 10px;">
	            		<s:url var="patientXrayAddUrl" namespace="/patient-request-xray" action="form.html"></s:url>
				     	<s:a href="%{#patientXrayAddUrl}" cssClass="mainSelect purple">
						    <i class="glyphicon glyphicon-comment" style="padding: 10px;"></i>Request for Radiograph
						</s:a>
	            	</div>
	            	<div class="col-md-4 col-sm-6 col-xs-12" style="padding: 10px;">
	            		<s:url var="patientCTAddUrl" namespace="/patient-request-conebeam" action="form.html"></s:url>
	            	...
	            	<div class="col-md-4 col-sm-6 col-xs-12" style="padding: 10px;">
	            		<s:url var="patientHBIAddUrl" namespace="/patient-request-HBI" action="form.html"></s:url>
			    ...
			    <div class="row">
	            	<div class="col-md-4 col-sm-6 col-xs-12" style="padding: 10px;">
	            		<s:url var="patientBiopsyAddUrl" namespace="/patient-request-biopsy" action="form.html"></s:url>
				     	<s:a href="%{#patientBiopsyAddUrl}" cssClass="mainSelect purple">
