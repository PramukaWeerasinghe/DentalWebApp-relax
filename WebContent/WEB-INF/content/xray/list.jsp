	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<s:include value="/WEB-INF/content/xray/header.jsp"></s:include>
				<div class="row">
					<h3>
						X-ray Reports <span style="font-size: 0.6em"> (Number of
							Reports: <s:property value="%{pager.list.size}" /> )
						</span>
					</h3>
				</div>
					...
					<table class="table table-condensed" id="patient_tbl">
						...
						<s:iterator value="pager.list" status="rowIndex">
							<tr>
								...
								<td><s:url var="downloadXrayUrl" namespace="/document"
										action="download-xray-report.html">
										<s:param name="entityId" value="%{id}"></s:param>
									</s:url> <s:a href="%{#downloadXrayUrl}"
