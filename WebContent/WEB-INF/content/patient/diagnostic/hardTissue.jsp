...
<body class="nav-md">
    ...
    <h2>Hard Tissue Examination</h2>     
      		...
      		<div class="col-xs-2">
					...
					<s:a href="%{#dietaryHabits}" cssClass="btn btn-info">Previous</s:a>
				</div>

				<div class="col-md-2 col-sm-3 col-xs-3 pull-right ">
					<s:url var="occlusalRelationship" namespace="/occlusal-relation"
						action="form.html">
						<s:param name="patientId" value="%{patient.id}"></s:param>
					</s:url>
					<s:a href="%{#occlusalRelationship}" cssClass="btn btn-info">Next</s:a>
				</div>
