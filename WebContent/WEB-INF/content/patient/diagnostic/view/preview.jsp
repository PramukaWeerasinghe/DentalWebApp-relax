			...
			<div class="right_col" role="main" id="full">
				...
				<s:if
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-12 pull-left">
							...
							<s:url var="patientXrayAddUrl" namespace="/patient-request-xray"
								action="form.html">
								<s:param name="id" value="%{patientId}"></s:param>
							</s:url>

							<s:a href="%{#patientXrayAddUrl}" cssClass="btn btn-default">
								<i class="glyphicon glyphicon-comment"></i> Request for Radiograph
						</s:a>
						</div>

						<div class="col-md-3 pull-right">
							<s:url var="viewList" namespace="/patient-diagnostic-report-list"
								action="list.html">
								<s:param name="patientId" value="%{patientId}"></s:param>
							</s:url>
							<s:a href="%{#viewList}" cssClass="btn btn-warning">
						...
						<div class="col-md-2 pull-right">
							...
							<s:a href="%{#patientViewUrl}" cssClass="btn  btn-primary"
								role="button">Patient's Details</s:a>
						</div>


						<div class="col-md-2 pull-right">
							<s:url var="printReportUrl" namespace="/patient-diagnostic"
								action="patient-diagnostic-information-pdf.html">
								<s:param name="id" value="%{commonId}"></s:param>
							</s:url>
							<s:a href="%{#printReportUrl}" cssClass="btn  btn-primary"
								role="button">
					...
					<div class="col-lg-4 ">
						<s:if
							...
							<s:url var="addDiagnostic" namespace="/patient-complaint"
								action="resubmitForm.html">
								<s:param name="patientId"
									value="#session.PATIENT_DIAGNOSTIC.patientDiagnosticComplaint.patientId"></s:param>
							</s:url>
							<s:a href="%{#addDiagnostic}" cssClass="btn btn-info btn-sm">Edit Reports</s:a>
						</s:if>
					</div>
				</div>
				<br>
				<div class="row">
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticComplaint.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticComplaint.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticComplaint_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticComplaint.comment != null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticComplaint.comment.trim().length() != 0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="panel panel-success">
							<div class="panel-heading">Dental History</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<s:if
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticDentalHistory.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticDentalHistory.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticDentalHistory_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticDentalHistory.comment != null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticDentalHistory.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Medical Record(Allergies)</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<s:if
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord1.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord1.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticMedicalRecord1_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord1.comment != null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord1.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Medical Record(B-E)</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord2.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord2.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticMedicalRecord2_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord2.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord2.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Medical Record(G-N)</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<s:if
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord3.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord3.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticMedicalRecord3_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord3.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord3.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Medical Record(P-T)</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<s:if
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord4.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord4.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticMedicalRecord4_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord4.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticMedicalRecord4.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Drug History(Phase1)</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<s:if
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticDrugHistory.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticDrugHistory_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticDrugHistory.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticDrugHistory.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Drug History(Phase2)</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<table class="table">
									<thead>
										<tr>
									...
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												...
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticDrugHistory.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticDrugHistory_comment2"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
							...
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-lg-6">
												...
												<s:label>Blood pressure tested date:</s:label>
											</div>
											<div class="col-lg-6">
												<s:property
								...
								<s:if
									...
									<div class="form-group">
										<div class="row">
											<div class="col-lg-6">
												<s:label>Haemotological tested date:</s:label>
											</div>
											<div class="col-lg-6">
												<s:property
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticInvestigation.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticInvestigation.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticInvestigation_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticInvestigation.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticInvestigation.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
				...
				<div class="row">
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Habits1</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<s:if
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticHabits1.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticHabits1.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticHabits1_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticHabits1.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticHabits1.comment.trim().length !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Habits2</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<s:if
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticHabits2.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticHabits2.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticHabits2_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticHabits2.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticHabits2.comment.trim().length !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Brushing Habits</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								<div class="form-group">
									<div class="row">
										<div class="col-md-3 col-sm-4 col-xs-12">
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											...
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticBrushingHabits.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticBrushingHabits.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticBrushingHabits_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticBrushingHabits.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticBrushingHabits.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
				...
				<div class="row">
					<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-success">
							<div class="panel-heading">Dietary Habits</div>
							<div class="panel-body" style="overflow-x: scroll; height: 300px">
								...
								<s:if test="doctor">
									<div class="row">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<s:textarea
												name="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticDietaryHabits.comment}"
												value="%{#session.PATIENT_DIAGNOSTIC.patientDiagnosticDietaryHabits.comment}"
												maxlength="255" cssClass="form-control col-md-3" rows="3"
												id="patientDiagnosticDietaryHabits_comment"></s:textarea>
										</div>
									</div>
								</s:if>
								<s:if
									test="!doctor && #session.PATIENT_DIAGNOSTIC.patientDiagnosticDietaryHabits.comment !=null && #session.PATIENT_DIAGNOSTIC.patientDiagnosticDietaryHabits.comment.trim().length() !=0">
									<div class="row">
										<div>
											<div class="col-md-3 col-sm-4 col-xs-12">
												<label>Comment:</label>
										...
										<div class="panel-body">
											...
											<div class="row">
												<div class="col-md-4">
													...
													<s:form namespace="/patient-diagnostic-report-list"
														action="activateDiagnosticDetailsWithComment"
														method="post">

														<s:hidden name="commonId" id="commonId_id"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticComplaint_comment"
															id="comment1"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticDentalHistory_comment"
															id="comment2"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticMedicalRecord1_comment"
															id="comment3"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticMedicalRecord2_comment"
															id="comment4"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticMedicalRecord3_comment"
															id="comment5"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticMedicalRecord4_comment"
															id="comment6"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticDrugHistory_comment"
															id="comment7"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticDrugHistory_comment2"
															id="comment8"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticInvestigation_comment"
															id="comment9"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticHabits1_comment"
															id="comment10"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticHabits2_comment"
															id="comment11"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticBrushingHabits_comment"
															id="comment12"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticDietaryHabits_comment"
															id="comment13"></s:hidden>

														<s:submit id="acceptWithCommentBtn"
															cssClass="btn btn-success"
															value="Accept with comments or without comments"></s:submit>
												...
												<div class="col-md-2">
													<s:form namespace="/patient-diagnostic-report-list"
														action="rejectDiagnosticDetailsWithComment" method="post">

														<s:hidden name="commonId" id="commonId_id"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticComplaint_comment"
															id="comment14"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticDentalHistory_comment"
															id="comment15"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticMedicalRecord1_comment"
															id="comment16"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticMedicalRecord2_comment"
															id="comment17"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticMedicalRecord3_comment"
															id="comment18"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticMedicalRecord4_comment"
															id="comment19"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticDrugHistory_comment"
															id="comment20"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticDrugHistory_comment2"
															id="comment21"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticInvestigation_comment"
															id="comment22"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticHabits1_comment"
															id="comment23"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticHabits2_comment"
															id="comment24"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticBrushingHabits_comment"
															id="comment25"></s:hidden>
														<s:hidden
															name="diagnosticReportComments.patientDiagnosticDietaryHabits_comment"
															id="comment26"></s:hidden>

														<s:submit id="rejectWithCommentBtn"
															cssClass="btn btn-warning" value="Reject with Comment"></s:submit>
										...
										.keypress(
												function() {
													...
													$('#comment1')
															.val(
																	$(
																			'#patientDiagnosticComplaint_comment')
																			.val());
													$('#comment2')
															.val(
																	$(
																			'#patientDiagnosticDentalHistory_comment')
																			.val());
													$('#comment3')
															.val(
																	$(
																			'#patientDiagnosticMedicalRecord1_comment')
																			.val());
													$('#comment4')
															.val(
																	$(
																			'#patientDiagnosticMedicalRecord2_comment')
																			.val());
													$('#comment5')
															.val(
																	$(
																			'#patientDiagnosticMedicalRecord3_comment')
																			.val());
													$('#comment6')
															.val(
																	$(
																			'#patientDiagnosticMedicalRecord4_comment')
																			.val());
													$('#comment7')
															.val(
																	$(
																			'#patientDiagnosticDrugHistory_comment')
																			.val());
													$('#comment8')
															.val(
																	$(
																			'#patientDiagnosticDrugHistory_comment2')
																			.val());
													$('#comment9')
															.val(
																	$(
																			'#patientDiagnosticInvestigation_comment')
																			.val());
													$('#comment10')
															.val(
																	$(
																			'#patientDiagnosticHabits1_comment')
																			.val());
													$('#comment11')
															.val(
																	$(
																			'#patientDiagnosticHabits2_comment')
																			.val());
													$('#comment12')
															.val(
																	$(
																			'#patientDiagnosticBrushingHabits_comment')
																			.val());
													$('#comment13')
															.val(
																	$(
																			'#patientDiagnosticDietaryHabits_comment')
																			.val());
