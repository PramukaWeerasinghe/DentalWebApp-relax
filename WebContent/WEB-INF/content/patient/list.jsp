							...
							<s:iterator value="pager.list" status="rowIndex">
								<tr>
									...
									<td><s:url var="patientViewUrl" namespace="/patient"
											...
											cssClass="btn btn-xs btn-primary" role="button">View</s:a> <s:if
											test="!student">
											<s:url var="patientEditUrl" namespace="/patient"
												action="edit">
												<s:param name="id" value="%{id}"></s:param>
											</s:url>
											<s:a href="%{#patientEditUrl}"
												cssClass="btn btn-xs btn-warning">Edit</s:a>

										</s:if> <s:url var="printA4Url" namespace="/patient"
											action="information-pdf">
											<s:param name="id" value="%{id}"></s:param>
										</s:url> <s:a href="%{#printA4Url}" cssClass="btn btn-xs btn-success"
											target="_blank">
